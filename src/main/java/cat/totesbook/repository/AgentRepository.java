...
public interface AgentRepository {
    ...
    /**
     * AFEGIT: Actualitza el 'tipus' (rol) d'un agent a la base de dades.
     * Aquest mètode és necessari per al CanviRolServlet.
    ...
    /**
     * AFEGIT: Retorna una llista de tots els Agents (bibliotecaris i administradors).
     * Aquest mètode és necessari per al dashboard_admin.jsp per poder llistar els agents.
