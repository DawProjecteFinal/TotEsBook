...
public interface AgentRepository {
    ...
    /**
     * Comprova el login d'un Agent verificant la seva contrasenya
     * hashejada.
     *
    ...
    /**
     * Actualitza el 'tipus' (rol) d'un agent a la base de dades. Aquest
    ...
    /**
     * Retorna una llista de tots els Agents (bibliotecaris i
     * administradors).
     *
