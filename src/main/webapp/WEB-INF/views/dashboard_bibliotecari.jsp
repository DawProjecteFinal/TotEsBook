                    ...
                    <div class="container px-4 px-lg-5 mt-5">
                            ...
                            <div class="col-6 col-md-3">
                                <div class="card shadow-sm border-start border-4 border-danger">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted small mb-0">Reserves amb retard</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <li class="nav-item">
                                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#retards">
                                    <img src="${pageContext.request.contextPath}/assets/icons/retards.png"
                                         alt="Propostes" style="width:40px; height:40px;">Reserves amb retard
                                </button>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade p-3" id="retards">
                                <h4 class="mb-3">Reserves amb retard a la teva biblioteca</h4>
