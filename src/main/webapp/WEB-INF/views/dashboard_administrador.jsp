                        ...
                        <c:otherwise>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownUsuari">
                                    <li><a class="dropdown-item active" href="${pageContext.request.contextPath}/dashboard_admin.jsp">Panell Admin</a></li>
                                    <li><a class="dropdown-item" href="${pageContext.request.contextPath}/dashboard_bibliotecario.jsp">Panell Bibliotecari</a></li> <%-- Accés ràpid si també és biblio --%>
                                    <li><hr class="dropdown-divider"></li>
