                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="form-page-container mt-5">
                            ...
                            <form action="${pageContext.request.contextPath}/registre" method="POST">
                                ...
                                <button type="button" class="btn btn-primari-custom btn-lg w-100"
                                        onclick="alert('El registre encara no està implementat. Si us plau, contacta amb el bibliotecari per crear el teu compte.')">
                                    Registrar-se
                                </button>
                            </form>
